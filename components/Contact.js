          ...
          <div className="md:ml-4">
            ...
            <div className="inline-flex flex-col w-full my-20 icons-container">
              <a href="tel:+543425220522">
                <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-white p-4">
                  <svg
              ...
              <a href="mailto:brandonb2816@gmail.com">
                <div className="flex flex-row items-center space-x-6 rounded-md border my-4 border-[#02044A] hover:border hover:border-white p-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
